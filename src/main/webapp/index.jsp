...
<html>
	...
	<body>
		...
		<div>
			...
			<form action="/LienzoArt/formulario" method="post" class="form_usuario">
				
		        <div>
	            	<label>Cedula</label>
	            	<input type="text" placeholder="su cedula" id="cedula" name="cedula">
	            	
	            	<%if(errores != null && errores.containsKey("cedula")){%>
	            			
            			<h5><% out.print(errores.get("cedula")); %></h5>
		        ...
		        <div>
					...
					<%if(errores != null && errores.containsKey("nombre")){%>
            			...
            			<h5><% out.print(errores.get("nombre")); %></h5>
	       		...
	       		<div>
					...
					<input type="text" placeholder="sus apellidos" id="apellidos" name="apellidos">	
					<%if(errores != null && errores.containsKey("apellidos")){%>
	            			
            			<h5><% out.print(errores.get("apellidos")); %></h5>
	       		...
	       		<div>
	            	<label>Correo</label>
					<input type="text" placeholder="su correo" id="correo" name="correo">
					
					<%if(errores != null && errores.containsKey("correo")){%>
	            			
            			<h5><% out.print(errores.get("correo")); %></h5>
	   			...
	   			<div>
					...
					<%if(errores != null && errores.containsKey("password")){%>
            			...
            			<h5><% out.print(errores.get("password")); %></h5>
	   			...
	   			<div>
					...
					<input type="text" placeholder="su telefono" id="telefono" name="telefono">
					<%if(errores != null && errores.containsKey("telefono")){%>
	            			
            			<h5><% out.print(errores.get("telefono")); %></h5>
	            ...
	            <div class="p_ciudades"> 
	                ...
	                <select name="ciudades" id="" class="ciudades">
	                    ...
	                    <option value="05615">San Carlos</option>
	                ...
	                <%if(errores != null && errores.containsKey("ciudades")){%>
            			...
            			<h5><% out.print(errores.get("ciudades")); %></h5>
	   			...
	   			<div>
					...
					<input type="text" placeholder="su codigo postal" id="codigoPostal" name="codigoPostal">
					<%if(errores != null && errores.containsKey("codigoPostal")){%>
	            			
            			<h5><% out.print(errores.get("codigoPostal")); %></h5>
				...
				<div>
	            	...
	            	<input type="text" placeholder="su direccion" id="codigoPostal" name="direccion">
	            	<%if(errores != null && errores.containsKey("direccion")){%>
	            			
            			<h5><% out.print(errores.get("direccion")); %></h5>
